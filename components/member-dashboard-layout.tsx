...
const navigation = [
  ...
  { name: "My Workouts", href: "/member-dashboard/workouts", icon: Dumbbell },
  { name: "Progress", href: "/member-dashboard/progress", icon: TrendingUp },
  { name: "Messages", href: "/member-dashboard/messages", icon: MessageCircle },
  { name: "Profile", href: "/member-dashboard/profile", icon: User },
  { name: "Settings", href: "/member-dashboard/settings", icon: Settings },
];
